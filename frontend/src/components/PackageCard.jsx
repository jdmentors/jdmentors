...
function PackageCard({ _id, title, description, services = [], addons = [], extras = [], price, process }) {
    ...
    return (
        <div className={`package-card bg-white rounded-xl overflow-hidden border border-blue-100 transition duration-300 flex flex-col relative ${_id == '68b01ac311cd8661cbde73f8' ? 'scale-105 shadow-lg shadow-blue-200 z-10' : _id =='68b01b7311cd8661cbde73fe' ? '[box-shadow:0_25px_50px_-12px_rgba(249,115,22,0.8),0_-25px_50px_-12px_rgba(249,115,22,0.8)]' : 'shadow-lg shadow-blue-200'} `}>
                                ...
                                <ul className={` space-y-2 mb-4 ${_id == '68b01ac311cd8661cbde73f8'? 'text-white' : _id == '68b01b7311cd8661cbde73fe' ? 'text-black' : 'text-gray-600'}`}>
                                    {services.map((service) => (
                                        <li key={service} className="flex items-start gap-1">
                                            <Settings className={`text-sm mt-1 flex-shrink-0 ${_id == '68b01ac311cd8661cbde73f8'? 'text-white' : _id == '68b01b7311cd8661cbde73fe' ? 'text-black' : 'text-blue-600'}`} size={18} />
                                            <span>{service}</span>
                                        </li>
                                    ))}
                                </ul>
                                ...
                                <ul className={` space-y-2 mb-4 ${_id == '68b01ac311cd8661cbde73f8'? 'text-white' : _id == '68b01b7311cd8661cbde73fe' ? 'text-black' : 'text-gray-600'}`}>
                                    {addons.map((addon) => (
                                        <li key={addon} className="flex items-start gap-1">
                                            <Plus className={`text-sm mt-1 flex-shrink-0 ${_id == '68b01ac311cd8661cbde73f8'? 'text-white' : _id == '68b01b7311cd8661cbde73fe' ? 'text-black' : 'text-blue-600'}`} size={18} />
                                            <span>{addon}</span>
                                        </li>
                                    ))}
                                </ul>
                                ...
                                <ul className={` space-y-2 mb-6 ${_id == '68b01ac311cd8661cbde73f8'? 'text-white' : _id == '68b01b7311cd8661cbde73fe' ? 'text-black' : 'text-gray-600'}`}>
                                    {extras.map((extra) => (
                                        <li key={extra} className="flex items-start gap-1">
                                            <Gift className={`text-sm mt-1 flex-shrink-0 ${_id == '68b01ac311cd8661cbde73f8'? 'text-white' : _id == '68b01b7311cd8661cbde73fe' ? 'text-black' : 'text-blue-600'}`} size={18} />
                                            <span>{extra}</span>
                                        </li>
                                    ))}
                                </ul>
