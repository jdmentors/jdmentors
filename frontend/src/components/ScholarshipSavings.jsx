import { DollarSign, TrendingUp, Award } from "lucide-react";
  ...
  function ScholarshipSavings({
      ...
      total = "$2.5M+",
      description = "Across our students, we've helped negotiate and secure millions in merit-based scholarships and
  financial aid — turning admit letters into affordable degrees.",
      breakdown = defaultBreakdown,
  }) {
      return (
          <section className="mt-14 md:mt-18">
              <Container>
                  <div className="rounded-2xl bg-gradient-to-br from-blue-600 to-blue-800 text-white p-8 md:p-12
